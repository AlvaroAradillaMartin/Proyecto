 ...
 * @author hp
 */
@WebServlet(name = "GestionUsuario", urlPatterns = {"/cliente/GestionUsuario"})
public class GestionUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String vista = "/cliente/gestionUsuario.jsp";
        ...
        if (validarUsuario(usu) && validarContrasena(contrasena) && validarCorreo(correo)) {
            String error = ModeloUsuario.actualizarUsuario(usuario, usu, contrasena, correo);
            sesion.setAttribute("error", error);
            vista="/cliente/Gestionar";
        }
