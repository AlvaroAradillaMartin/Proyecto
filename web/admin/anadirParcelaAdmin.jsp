...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="AnadirParcelaAdmin" method="post" onsubmit="return validarParcela()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="localizacionParcela" name="localizacionParcela" required>
                </div>            
                <div class="form-group">
                    <label for="tamano">Tamaño (hectáreas):</label>
                    <input type="number" id="tamanoParcela" name="tamanoParcela" step="0.01" required>
                </div>
                <div class="form-group d-flex justify-content-around    ">
                    <button type="submit">Guardar parcela</button>
                    <button class="boton"><a href="GestionarParcelasAdmin?id=${id}"> Volver al menú</a></button>
                </div>
            </form>
