...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="AnadirServicio" method="post" onsubmit="return validarServicio()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="precio" name="precio" step="0.1"  required>
                </div>            
                <div class="form-group">
