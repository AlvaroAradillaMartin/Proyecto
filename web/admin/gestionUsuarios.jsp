                    ...
                    <tbody>
                        <c:forEach var="usuario" items="${usuarios}">
                            <tr>
                                ...
                                <td> <ul>
                                        <c:forEach var="parcela" items="${usuario.parcelas}">
                                ...
                                <td class="d-flex justify-content-center"> <a href="GestionarUsuarioAdmin?id=${usuario.id}"> <button class="boton">Gestionar</button> </a> 
                                    <form action="EliminarUsuario?id=${usuario.id}" method="post" onsubmit="return confirmarEliminacion(event)">
...
<%
    ...
    Boolean editadoExitoso = (Boolean) sesion.getAttribute("editado");
    if (editadoExitoso != null && editadoExitoso) {
%>
<script>
    Swal.fire({
        icon: 'success',
        title: '¡Gestión exitosa!',
        text: 'Se ha gestionado el usuario correctamente.',
        showConfirmButton: true
    });
</script>
<%
} else if (editadoExitoso != null && !editadoExitoso) {
...
<script>
    Swal.fire({
        ...
        text: 'No se ha podido gestionar el usuario correctamente.',
        showConfirmButton: true
    });
</script>
