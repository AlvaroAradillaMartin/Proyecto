                        ...
                        <a href="GestionUsuario">
                            <div class="card">
                                ...
                                <div
                                    ...
                                    >
                                    <h5 class="card-title text-center">Gestionar Usuario</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col d-flex align-items-center justify-content-center">
                        <button class="boton"> <a href="../menuPrincipal.jsp">Menu Principal</a> </button>
                    </div>
                    <div class="col d-flex justify-content-center">
                        <a href="GestionParcelas">
                            <div class="card">                            
                                <img src="../imagenes/footer.jpg" class="card-img-top" alt="..." />
                                <div
                                    class="card-body d-flex align-items-center justify-content-center"
                                    >
                                    <h5 class="card-title text-center">Gestionar Parcelas</h5>
                                </div>
                            </div>
                        </a>
                    </div>
...
<%
    ...
    if (error != null) {
        if (error.equals("Actualizado con exito")) {
...
<script>
    Swal.fire({
        ...
        text: 'Los datos de su cuenta han sido actualizados correctamente.',
