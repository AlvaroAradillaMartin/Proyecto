...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <h2>Editar Datos</h2>
            <form action="GestionUsuario" method="post" onsubmit="return validarRegistro()">
                <div class="form-group">
                    <label for="UsuarioRegistro">Usuario:</label>
                    <input type="text" id="UsuarioRegistro" name="usuario" value="${usu.nombre}" required>
                </div>
                <div class="form-group">
                    <label for="ContrasenaRegistro">Contraseña:</label>
                    <input type="password" id="ContrasenaRegistro" name="contrasena" value="${usu.contrasena}" required>
                </div>
                <div class="form-group">
                    <label for="Email">Correo:</label>
                    <input type="email" id="Email" name="correo" value="${usu.correo}" required>
                </div>

                <div class="form-group d-flex justify-content-around">
                    <button type="submit">Editar</button>
                       <button class="boton"><a href="Gestionar"> Volver al menú</a></button>
                </div>
            </form>
