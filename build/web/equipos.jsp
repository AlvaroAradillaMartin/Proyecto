<%-- 
    Document   : equipos
    Created on : 19 mar 2024, 20:23:29
    Author     : hp
--%>
        ...
        <div class="container text-center mt-5">
          <div class="row" id="columna">
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/36.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
            <div class="col d-flex align-items-center">
              <h3 class="titulo">Nuestros Equipos</h3>
            </div>
            <div class="col d-flex align-items-center">
              <p class="texto">
                Contamos con maquinaria de última tecnología preparada para la
                realización de las labores de nivelación y trasporte de tierras,
                así como todo tipo de implementos agrícolas.
              </p>
            </div>
          </div>
          <div class="row mt-5 gap-2">
            ...
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/38.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/41.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
          </div>
          ...
          <div class="row mt-5 gap-2">
            ...
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/43.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/28.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
            <div class="col d-flex justify-content-center">
              <div class="card">
                <img src="imagenes/40.jpg" class="card-img-top" alt="..." />
              </div>
            </div>
          </div>
        </div>
