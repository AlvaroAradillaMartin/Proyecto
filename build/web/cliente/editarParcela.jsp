...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2>Formulario de Parcela</h2>
            <form action="EditarParcela" method="post" onsubmit="return validarParcela()">
                <input type="hidden" name="id" value="${parcela.id}"> 
                <div class="form-group">
                    <label for="nombre">Nombre:</label>
                    <input type="text" id="nombreParcela" name="nombreParcela" value="${parcela.nombre}" required >
                </div>
                <div class="form-group">
                    <label for="localizacion">Localización:</label>
                    <input type="text" id="localizacionParcela" name="localizacionParcela" value="${parcela.localizacion}" required>
                </div>            
                <div class="form-group">
                    <label for="tamano">Tamaño (hectáreas):</label>
                    <input type="number" id="tamanoParcela" name="tamanoParcela" value="${parcela.tamano}" step="0.01" required>
                </div>
                <div class="form-group">
                    <input type="submit" value="Guardar Parcela">
                </div>
            </form>
                <div class="form-group d-flex justify-content-center">
                    <a href="GestionParcelas">
