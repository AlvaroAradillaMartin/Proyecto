...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <article class="text-center titulo">Gestionar Servicios</article>
            <article class="d-flex justify-content-around text-center mt-5">
                <div class="row gap-5 w-100">
                      <div class="col d-flex justify-content-center">
                        <a href="AnadirServicio">
                            <div class="card" id="anadirServicio">
                                <div id="plus"><i class="bi bi-plus-lg"></i></div> 
                    ...
                    <c:forEach var="servicio" items="${servicios}">
                        ...
                        <div class="col d-flex justify-content-center">
                            <div class="card">
                                <img src="http://localhost:8080/proyectoFinal/${servicio.imagen}" class="card-img-top" alt="..." />
                                <div
